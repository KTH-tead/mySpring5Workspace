...
<head>
  ...
  <title>All Things(ë§ë¬¼ìí)</title>
...
<body id="me">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#me">ìíì¬ë¦¬ê¸°</a></li>
          <li><a class="nav-link scrollto" href="blog.html">ìíë¤</a></li>
          <li><a class="nav-link scrollto" href="#me">ë´ ê·¼ì²</a></li>
          <li><a class="nav-link scrollto" href="#me">ìì ê²ìí</a></li>
          <li><a class="nav-link scrollto " href="#me">Login</a></li>
          <li><a class="nav-link scrollto " href="#me">ë§ì´íì´ì§</a></li>
          <li><a class="nav-link scrollto " href="">ê´ë¦¬ì</a></li>
  ...
  <section id="hero">
    <div class="hero-container">
      <h3>Welcome to <strong>ì¬ëµì¤</strong></h3>
      <h2 class="mb-0">ë¹ì ìê² ë¹ì¥ íìì¹ ìì ë¬¼ê±´ì´,</h2>
      <h2 class="mt-1">ëêµ°ê°ìê² ë¹ì¥ íìíë¤ë©´? </h2>
      <a href="#me" class="btn-get-started scrollto ">ì¬ëµì¤ì í¨ê»íì¸ì</a>
    </div>
  </section><!-- End ë©ì¸ ì¤ëª -->
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <h3><span>ì¬ëµì¤ë?</span></h3>
          <p class="mb-1">í¨ì¨ì± ìµê³  ìíë¶í°, ë¤ìí ì´ì¼ê¸° ê³µì ê¹ì§, <br>ëª¨ëê° íë³µí´ì§ë ì¬ëµì¤</p>
          <p class="mt-1"> </p>
        </div>
        ...
        <div class="row content">
          ...
          <div class="col-lg-4 col-6">
            ...
            <ul class="justify-content-end" style="top:50px; margin-top: 100px;">
              <li><i class="ri-check-double-line"></i>ìµê³ ì ìíì ì ë ´íê² êµ¬ë§¤íê³  ì¶ëì?</li>
              <li><i class="ri-check-double-line"></i>ì§ìì ìë¦¬ë§ ì°¨ì§íë ë¬¼ê±´ì ì²ë¶íê³  ì¶ëì?</li>
              <li><i class="ri-check-double-line"></i>ë¤ìí ì¹êµ¬ì ì´ì¼ê¸°ë¥¼ ëëê³  ì¶ëì?</li>
            </ul>
          </div>
    ...
    <section id="services" class="services">
      <div class="container">
        <div class="text-center">
          <h2 class="nanum-bold">ì ìì í, ì±, ìë¥ ë± ëª¨ë  ê²ë¤ì ì°¾ì ì ìë ì¬ëµì¤</h2>
        </div>
        <!-- ìµê³  ì¸ê¸° ìí -->
        <div class="my-3">
          <div class="dropdown ">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              <li><a class="dropdown-item" href="#me">ìë¥</a></li>
              <li><a class="dropdown-item" href="#me">ì ìê¸°ê¸°</a></li>
              <li><a class="dropdown-item" href="#me">ì¡ì¸ìë¦¬</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
              ...
              <div class="product-img" style="background-image: url(./assets/images/item-6.jpg);">
                ...
                <div class="cart">
                  <p>
                    ...
                    <span><a href="#me"><i class="fas fa-heart"></i></a></span>
                    <span><a href="add-to-wishlist.html">10</a></span>
                  </p>
                </div>
              </div>
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">ëª©ê±¸ì´</a></h3>
                <p class="price"><span>50,000</span>ì</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">ì ê¸ë¼ì¤</a></h3>
                <p class="price"><span>20,000</span>ì</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">í¸ë ì´ëë³µ</a></h3>
                <p class="price"><span>30,000</span>ì</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">ë¨ì± ì ì¥</a></h3>
                <p class="price"><span>60,000</span>ì</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">í°ìì¸ </a></h3>
                <p class="price"><span>10,000</span>ì</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">ì¤í¸ë¼ì´í í°ìì¸ </a></h3>
                <p class="price"><span>20,000</span>ì</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">ëí¸</a></h3>
                <p class="price"><span>30,000</span>ì</p>
              </div>
            </div>
          </div>
          <div class="col-md-3 text-center">
            <div class="product-entry">
              ...
              <div class="desc">
                <h3><a class="nanum-bold" href="shop.html">ìì¼</a></h3>
                <p class="price"><span>60,000</span>ì</p>
              </div>
            </div>
          </div>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center">
          <h3>ì¬ëµì¤ì í¨ê»íì¸ì</h3>
          <h6 class="mb-3 text-white">ë¹ì ìê² ë¹ì¥ íìì¹ ìì ë¬¼ê±´ì´,</h2>
          <h6 class="mt-3 text-white">ëêµ°ê°ìê² ë¹ì¥ íìíë¤ë©´? </h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box">
              ...
              <div class="btn-wrap">
                <a href="#me" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          <div class="col-6 footer-contact">
            <a href="#me"><img src="assets/img/logoKrS.png" alt="" class="img-fluid mb-2" style="height: 10vh;"></a>
            <p class="nanum-bold">
              ì£¼ìíì¬ì¬ëµì¤ / ì¬ììë²í¸ : 123-45-67890 / ëíì´ì¬ : íê¸¸ë
            </p>
            <p class="nanum-bold">
              ìì¸ì êµ¬ë¡êµ¬ ìí¥ëë¡ 163ê¸¸ 33 ì£¼í¸íì 2ì¸µ (êµ¬ë¡ë 1129-1) <br><br>
          ...
          <div class="col-6  footer-links">
            <h4>Links</h4>
            <ul class="row">
              <li><i class="bx bx-chevron-right"></i> <a class="nanum-bold" href="#me">ìíì¬ë¦¬ê¸°</a></li>
              <li><i class="bx bx-chevron-right"></i> <a class="nanum-bold" href="#me">ìíë¤</a></li>
              <li><i class="bx bx-chevron-right"></i> <a class="nanum-bold" href="#me">ë´ ê·¼ì²</a></li>
              <li><i class="bx bx-chevron-right"></i> <a class="nanum-bold" href="#me">ìì ê²ìí</a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong class="nanum-bold"><span class="nanum-bold">ì¬ëµì¤</span></strong>. All Rights Reserved
        </div>
        <!-- <div class="credits">
      ...
      <div class="social-links text-center text-md-right pt-3 pt-md-0">
        <a href="#me" class="twitter"><i class="bx bxl-twitter"></i></a>
        <a href="#me" class="facebook"><i class="bx bxl-facebook"></i></a>
        <a href="#me" class="instagram"><i class="bx bxl-instagram"></i></a>
      </div>
    </div>
      <a href="#me" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
