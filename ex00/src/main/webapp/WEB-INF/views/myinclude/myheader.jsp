			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown">
						<!-- href 속성 삭제 --> <i class="fa fa-user fa-fw"></i> <sec:authorize
							access="isAuthenticated()">
							<sec:authentication property="principal.username" />
							<span>님 접속</span>
						</sec:authorize> <i class="fa fa-caret-down"></i>
				</a>
					<ul class="dropdown-menu">
						<%-- 클래스 이름 중 dropdown-user 삭제 --%>
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li><a href="${contextPath}"> <i class="fa fa-home fa-fw"></i>
								Main page
						</a></li>
						<li><a href="${contextPath}/myboard/list"> <i
								class="fa fa-table fa-fw"></i> User Board
						</a></li>
						<li><a href="${contextPath}/myboard/register"> <i
								class="fa fa-edit fa-fw"></i> New Board Register
						</a></li>
						<li><a href="${contextPath}/login"> <i
								class="fa fa-sign-in fa-fw"></i> Sign in
						</a></li>
					</ul>
				</div>
			</div>
