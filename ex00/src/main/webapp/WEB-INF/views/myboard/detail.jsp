...
<!-- <%-- 댓글 화면 표시 시작, 붙여넣기 후, 아래의 style 태그 내용은 --%> -->
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="margin-bottom: 5px;">
                        <textarea class="form-control txtBoxCmt" name="rcontent" placeholder=" 댓글 작성 시 상대방에 대한 배려와 책임을 담아 주세요.&#10;댓글작성을 원하시면,댓글 작성 버튼을 클릭해주세요. " readonly="readonly"></textarea>
                    </div>
                    <hr style="margin-top: 10px; margin-bottom: 10px;">
                    <!-- 댓글 입력창 끝 -->
                    <ul class="chat">
                        <li class="left clearfix commentLi" data-bno="45872" data-rno="1">
                            <div>
                                <div>
                                ...
                                <div class="btnsComment" style="margin-bottom:10px">
                                    ...
                                    <textarea class="form-control txtBoxCmtMod" name="rcontent" style="margin-bottom:10px" placeholder="답글 작성 시 상대방에 대한 배려와 책임을 담아 주세요.&#10;답글작성을 원하시면,답글 작성 버튼을 클릭해주세요.">
                                    </textarea>
                                </div>
                            </div>
                        </li>
    ...
    <!-- page-wrapper 종료 div 는 화면 표시 요소 제일 밑에 위치해야 함. -->
...
<script>
        ...
        const commentUL = $(".chat");
        const frmCmtPagingValue = $("#frmCmtPagingValue");
                ...
                function (replyPagingCreator){
                    ...
                    if(!replyPagingCreator.replyList){
                        str += '<li class="left clearfix commentLi"'
                            + 'style="text-align: centerl background-color: lightCyan;'
                    ...
                    for (var i = 0, len = replyPagingCreator.replyList.length; i < len; i++) {
                        ...
                        } else if (replyPagingCreator.replyList[i].lvl == 3) {//답글 들여쓰기
                            str += ' <div style="padding-left:50px">';
                        } else if (replyPagingCreator.replyList[i].lvl == 4) {//답글 들여쓰기
...
//   {bno: bnoValue, rno: 8 },  function(data){
//       console.log(data);
//   }
// );
...
//댓글-답글 수정 테스트
/* myCommentClsr.modifyCmtReply(
  {bno : bnoValue, rno : 1, ccontent: "JS클로저에 의한 댓글 수정======="}	,
...
// myCommentClsr.removeCmtReply(
//   {bno : bnoValue, rno : 4, rwriter: "user41"},
//   function(deleteResult) {
//       console.log(deleteResult);
//       if (deleteResult === "댓글 삭제 성공") {
