...
//		MyReplyPagingCreatorDTO myReplyPagingCreator = myReplyService.getReplyListByBno(new MyReplyPagingDTO(229376, 1));
...
//		log.info(myReplyService.getReply(229376L, 6L));
//	}
...
//
//		MyReplyVO myReply = myReplyService.getReply(229376L, 6L);
//
//		if (myReply == null) {
//			return;
//		}
//
//		myReply.setRcontent("서비스-댓글 수정 테스트입니다. 수정");
//		
//		log.info("서비스-댓글 수정 테스트시 반환된 값(수정된 댓글 수): " + myReplyService.modifyReply(myReply));
//		log.info("서비스-댓글 수정 테스트: 수정 후 조회(수정된 myReplyVO): " + myReplyService.getReply(229376L, 6L));
//	}
...
//		log.info("서비스: 특정 게시물 삭제 테스트: " + myReplyService.removeReply(229376L, 19L));
//	}
}
