...
//				.perform(MockMvcRequestBuilders.put("/myboard/modify")
//											   .param("bno", "1")
...
//	            .perform(MockMvcRequestBuilders.put("/myboard/delete")
//											   .param("bno", "5")
//											   .param("bdelflag", "1"))
//				.andReturn()
//				.getModelAndView()
...
//	            .perform(MockMvcRequestBuilders.delete("/myboard/remove")
//											   .param("bno", "3"))
//				.andReturn()
//				.getModelAndView()
//				.getViewName();
...
//	            .perform(MockMvcRequestBuilders.delete("/myboard/removeAll"))
//				.andReturn()
//				.getModelAndView()
//				.getViewName();
//
