...
<%-- https://sanghye.tistory.com/16 : [Javascript] 새로고침 시 알림팝업 띄우고, 뒤로가기 버튼 클릭 시 띄우지 않기 
     https://aljjabaegi.tistory.com/450
     https://taewooblog.tistory.com/75
--%>
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <sec:authorize access="isAnonymous()">
                    <li><a id="myLogin" href="${contextPath}/myLoginPage"><i class="fa fa-sign-in fa-fw"></i>Login</a>
                    </li>
            </sec:authorize>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="${contextPath}/myboard/myBoardList"><i class="fa fa-dashboard fa-fw"></i>User Board</a>
                    </li>
                    <li>
                        <a href="${contextPath}/myboard/myBoardRegister"><i class="fa fa-edit fa-fw"></i>New Board Register</a>
                    </li>
                    <li>
