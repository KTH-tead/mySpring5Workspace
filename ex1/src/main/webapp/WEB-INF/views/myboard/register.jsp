				...
				<div class="panel-body">
					<form role="form" action="${contextPath}/myboard/register"
						...
						<div class="form-group">
							<labe>제목</label> <input class="form-control" name="btitle">
						</div>

						<div class="form-group">
							<labe>내용</label> <textarea class="form-control" rows="3"
								name="bcontent"></textarea>
						</div>
						<div class="form-group">
							<labe>작성자</label> <input class="form-control" name="bwriter">
						</div>
