...
import org.zerock.ex1.common.paging.MyBoardPagingDTO;
import org.zerock.ex1.domain.MyBoardVO;
...
//게시물 목록 조회 테스트1 <--테스트 후, 메서드 주석처리
	/*
	 * @Test public void testSelectBoardList() {
	 *
	 * myBoardMapper.selectMyBoardList().forEach(myBoard -> log.info(myBoard));
	 * myBoardMapper.selectMyBoardList().forEach(myBoard ->
...
//	  @Test public void testInsertMyBoard() { MyBoardVO myBoard = new MyBoardVO();
//	  myBoard.setBtitle("메퍼 테스트-입력제목"); myBoard.setBcontent("매퍼 테스트-입력내용");
...
//게시물 등록 테스트 - selectKey 사용
	  ...
	  @Test public void testInsertMyBoardSelectKey() {

	  MyBoardVO myBoard = new MyBoardVO(); myBoard.setBtitle("메퍼 테스트-select key");
	  myBoard.setBcontent("매퍼 테스트-select key"); myBoard.setBwriter("test01");
...
//	 @Test public void testUpdateBdelFlag() { myBoardMapper.updateBdelFlag(10L);
...
//	  @Test
//	  public void testDeleteMyBoard() { log.info("DELETE COUNT: " +
//	  myBoardMapper.deleteMyBoard(9L)); log.info(myBoardMapper.selectMyBoard(9L));
//	 }
...
//게시물 삭제 테스트 - 삭제 요청된 게시물들 전체 삭제 (관리자)
	/*
	 * @Test public void testDeleteAllBoard() { log.info("DELETE COUNT: " +
	 * myBoardMapper.deleteAllBoardSetDeleted());
	 * log.info(myBoardMapper.selectMyBoard(10L)); }
	 */
